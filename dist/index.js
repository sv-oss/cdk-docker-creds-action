...
var init_file_command = __esmMin((() => {
	init_utils();
}));
//#endregion
...
var import_tunnel, import_undici, __awaiter$9, HttpCodes, Headers, MediaTypes, HttpRedirectCodes, HttpResponseRetryCodes, RetryableHttpVerbs, ExponentialBackoffCeiling, ExponentialBackoffTimeSlice, HttpClientError, HttpClientResponse, HttpClient, lowercaseKeys;
var init_lib = __esmMin((() => {
	init_proxy();
	import_tunnel = /* @__PURE__ */ __toESM(require_tunnel(), 1);
	import_undici = require_undici();
...
var __awaiter$8, BearerCredentialHandler;
...
var __awaiter$7, OidcClient;
var init_oidc_utils = __esmMin((() => {
	init_lib();
	init_auth();
	init_core();
...
var __awaiter$6, access, appendFile, writeFile, SUMMARY_ENV_VAR, Summary, _summary, markdownSummary, summary;
var init_summary = __esmMin((() => {
	...
	({access, appendFile, writeFile} = fs.promises);
...
var __awaiter$5, chmod, copyFile, lstat, mkdir, open, readdir, rename, rm, rmdir, stat, symlink, unlink, IS_WINDOWS$1;
var init_io_util = __esmMin((() => {
	...
	IS_WINDOWS$1 = process.platform === "win32";
...
var __awaiter$3, IS_WINDOWS, ToolRunner, ExecState;
var init_toolrunner = __esmMin((() => {
	init_io();
	init_io_util();
	...
	ExecState = class ExecState extends events.EventEmitter {
...
var __awaiter$1, getWindowsInfo, getMacOsInfo, getLinuxInfo, platform, arch, isWindows, isMacOS, isLinux;
var init_platform = __esmMin((() => {
	...
	getWindowsInfo = () => __awaiter$1(void 0, void 0, void 0, function* () {
	...
	getMacOsInfo = () => __awaiter$1(void 0, void 0, void 0, function* () {
		var _a, _b, _c, _d;
	...
	getLinuxInfo = () => __awaiter$1(void 0, void 0, void 0, function* () {
...
var require_main = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const core = __importStar((init_core(), __toCommonJS(core_exports)));
	...
	async function run() {
		try {
			...
			const secretsManagerSecretId = core.getInput("secretsManagerSecretId", { required: false }) || void 0;
			const secretsUsernameField = core.getInput("secretsUsernameField", { required: false }) || void 0;
			const secretsPasswordField = core.getInput("secretsPasswordField", { required: false }) || void 0;
			const ecrRepository = core.getInput("ecrRepository", { required: false }) || void 0;
			const roleArn = core.getInput("roleArn", { required: false }) || void 0;
			if (secretsManagerSecretId === void 0 && ecrRepository === void 0) throw new Error("one of secretsManagerSecretId or ecrRepository must be set");
			if (secretsManagerSecretId !== void 0 && ecrRepository !== void 0) throw new Error("only one of secretsManagerSecretId or ecrRepository can be set");
			if (secretsManagerSecretId === void 0 && (secretsUsernameField !== void 0 || secretsPasswordField !== void 0)) throw new Error("secretsUsernameField/secretsPasswordField can only be set when secretsManagerSecretId is set");
			let configFilename = process.env.CDK_DOCKER_CREDS_FILE;
			let configContents;
			if (configFilename === void 0) {
				configFilename = path$1.join((0, fs_1.mkdtempSync)(`${(0, os_1.tmpdir)()}${path$1.sep}`), "cdk-docker-creds.json");
				configContents = {
					version: "1.0",
					domainCredentials: {}
				};
			} else configContents = JSON.parse((0, fs_1.readFileSync)(configFilename).toString());
			core.debug(`config filename = '${configFilename}'`);
			if (Object.keys(configContents.domainCredentials).includes(registryHost)) throw new Error(`registry ${registryHost} is already present in the configuration file`);
			configContents.domainCredentials[registryHost] = {
				ecrRepository: ecrRepository !== void 0 ? true : void 0,
				roleArn,
